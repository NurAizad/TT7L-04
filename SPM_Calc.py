...
def ChemistryPage(forget_surface, pack_surface):
    ...
    def chem_f4():
        ...
        chap6_button.grid(row=2,column=2,padx=20,pady=50)
    ...
    def chem_f5():
        ...
        def chem_f5_chap3():
            ...
            fuelValue_button.grid(row=2,column=1,pady=10,sticky="ew",padx=20)          
        ...
        f5Chapter_label.grid(row=0,column=2,padx=10,pady=10)
        chap3_button.grid(row=2,column=2,padx=20,pady=50)
